            ...
            <div id="dataKaryawan" class="font15">
                <div class="detailKaryawan">
                    <div class="kanan">
                        <button type="button" class="tombol" name="tombolEdit" onclick="aside28()"><i class="fas fa-edit"></i>Edit</button><br><br>
                        <img class="photo" src="HRD/HRD - Daftar Karyawan/profile_pic.jpg"/>
                    </div>
                    <div class="kiri">
                        <table>
                            <br><br>
