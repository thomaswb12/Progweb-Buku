...
<div id="dataKaryawan" class="font15">
     <div class="detailKaryawan">
        ...
        <div class="kanan">
            ...
            <img class="photo" src="HRD/HRD - Daftar Karyawan/profile_pic.jpg"/><br><br><br>
            <!-- tombol save -->
            <input type="button" id="tombolSave" name="tombokSave" class="tombol" value="SAVE" onclick="aside15()"/>
        </div>
    </div>
</div>