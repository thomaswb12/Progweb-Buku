<?php
    ...
    if(!isset($_SESSION['id'])){
        ...
        <head>
            ...
            <title>Gudang - Daftar Supplier</title>
            <link href="gudang - daftar supplier.css" type="text/css" rel="stylesheet">
            <script type="text/javascript" src="https://code.jquery.com/jquery-1.12.1.min.js"></script>
            <script src="gudang - daftar supplier.js"></script>
            ...
            <article>
                <div id="aside">
                    ...
                    <div id="option">
                        ...
                        <hr/>
                        <h3 class="blue" id="aside7"><span><i class="fas fa-angle-right"></i></span> Daftar Supplier</h3>
                        <hr/>
